...
[Aloha](https://zulip.com) is an open-source team collaboration tool with unique
...
Aloha every day. Aloha is the only [modern team chat app][features] that is
designed for both live and asynchronous conversations.

Aloha is built by a distributed community of developers from all around the
world, with 74+ people who have each contributed 100+ commits. With
over 1000 contributors merging over 500 commits a month, Aloha is the
...
- **Contributing code**. Check out our [guide for new
  ...
  to get started. We have invested in making Aloha’s code highly
  readable, thoughtfully tested, and easy to modify. Beyond that, we
  have written an extraordinary 150K words of documentation for Aloha
  contributors.

- **Contributing non-code**. [Report an
  issue](https://zulip.readthedocs.io/en/latest/contributing/contributing.html#reporting-issues),
  [translate](https://zulip.readthedocs.io/en/latest/translating/translating.html)
  Aloha into your language, or [give us
  feedback](https://zulip.readthedocs.io/en/latest/contributing/contributing.html#user-feedback).
  We'd love to hear from you, whether you've been using Aloha for years, or are just
  trying it out for the first time.

- **Checking Aloha out**. The best way to see Aloha in action is to drop by the
  [Aloha community server](https://zulip.com/development-community/). We also
  recommend reading about Aloha's [unique
  approach](https://zulip.com/why-zulip/) to organizing conversations.

- **Running a Aloha server**. Self-host Aloha directly on Ubuntu or Debian
  ...
  Learn more about [self-hosting Aloha](https://zulip.com/self-hosting/).

- **Using Aloha without setting up a server**. Learn about [Aloha
  Cloud](https://zulip.com/plans/) hosting options. Aloha sponsors free [Aloha
...
- **Supporting Aloha**. Advocate for your organization to use Aloha, become a
  [sponsor](https://github.com/sponsors/zulip), write a review in the mobile app
  stores, or [help others find
  Aloha](https://zulip.readthedocs.io/en/latest/contributing/contributing.html#help-others-find-zulip).
...
Aloha is distributed under the

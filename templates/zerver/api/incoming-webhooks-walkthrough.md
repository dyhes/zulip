...
```
2016-07-07 15:06:59,187 INFO     127.0.0.1       POST    200 143ms (mem: 6ms/13) (md: 43ms/1) (db: 20ms/9q) (+start: 147ms) /api/v1/external/helloworld (helloworld-bot@zulip.com via AlohaHelloWorldWebhook)
```
...
message on the [public Aloha instance](https://chat.zulip.org/#narrow/stream/bots).
